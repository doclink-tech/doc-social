...
import { Bookmark, BookText, Brain, FileBadge, Home, LibraryBig } from "lucide-react";
  ...
  return (
    ...
    <div className={className}>
      ...
      <Button
        ...
        asChild
      >
        <Link href="https://library.medcrizz.com/resources">
          <LibraryBig />
      ...
      <Button
        ...
        asChild
      >
        <Link href="https://library.medcrizz.com/blog">
          <BookText />
